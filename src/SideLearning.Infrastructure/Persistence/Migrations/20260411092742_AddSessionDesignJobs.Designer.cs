...
namespace SideLearning.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260411092742_AddSessionDesignJobs")]
    partial class AddSessionDesignJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SideLearning.Domain.SessionDesign.SessionDesignJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("session_design_jobs", (string)null);
                });
            ...
            modelBuilder.Entity("SideLearning.Domain.Sessions.Session", b =>
                {
                    ...
                    b.OwnsMany("SideLearning.Domain.Sessions.SessionSubjectArea", "SubjectAreas", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.ToTable("session_subject_areas", (string)null);
            ...
            modelBuilder.Entity("SideLearning.Domain.Users.User", b =>
                {
                    ...
                    b.OwnsMany("SideLearning.Domain.Users.UserInterest", "UserInterests", b1 =>
                        {
                            b1.Property<int>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("integer");
                            ...
                            b1.HasIndex("UserId", "Label")
                                .IsUnique();

                            b1.ToTable("user_interests", (string)null);
